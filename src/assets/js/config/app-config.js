...
const CONFIG = {
    ...
    SWORD: {
        ...
        BASE_RADIUS: 110,       // Khoảng cách từ tâm đến lớp kiếm đầu tiên (giảm để cụm kiếm sát hơn)
        LAYER_SPACING: 40,      // Khoảng cách giữa các lớp kiếm (vòng trong - vòng ngoài, giảm để đại trận gọn hơn)
